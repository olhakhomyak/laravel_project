...
<div class="container">
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default" id="userForm">
                <br><br><br><div style="text-align: center">{{ trans('messages.Login') }}</div>
                    ...
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/login') }}">
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-4">
                                ...
                                <a class="btn btn-link" href="{{ url('/password/reset') }}">{{ trans('messages.Forgot') }}</a>
                            </div>
                        </div>
                    </form>
                </div>
